...
#    Nbin_k = 300
    ...
    for iTree, tree in enumerate(trees):
        ...
        for ibin in range(Nbin_k):
            ...
            var = '(tau_iso_chargedPt + TMath::Max(0., tau_iso_neutralPt - tau_iso_dbeta*tau_iso_sumPUPt - tau_iso_offset + ' + str(dk) + '*tau_iso_wrms))'
    ...
    for ilabel, label in enumerate(pulabel):
        for iTree, tree in enumerate(trees):
            ...
            for ibin in range(Nbin_k):
                ...
                var = '(tau_iso_chargedPt + TMath::Max(0., tau_iso_neutralPt' + label + ' - tau_iso_offset' + label + '+' + str(dk) + '*tau_iso_wrms' + label + '))'
#                print var
    ...
    file = TFile('RejectionMap.root','recreate')
