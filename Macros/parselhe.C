...
void parselhe(//const char *infile="GF8TeV.mjj200.alpha0.00.part06.lhe",
	      TString infile="GF8TeV.mjj200.alpha0.00.part00.lhe",
	      ...
	      UInt_t entries=50000)
{
  ...
  //  TString ofile = "Myroot_";
  //  ofile += infile;
  //  ofile += ".root";
  //  TFile *outfile = new TFile("Myroot.root","recreate");
  ...
  tree->Branch("Events",&data,
	       "njet/i:scalePdf/F:weight:vmass:vpt:vy:vphi:vpx:vpy:vpz:x_1:x_2:id_1/I:id_2/I:aqcd/F:aqed:jetpt_1:jeteta_1:jetphi_1:jetpt_2:jeteta_2:jetphi_2:mjj/F:dphi/F:deta/F:dR/F"); 
