...
histPref['ZTT_left*'] = {'style':sHTT_DYJets, 'layer':0.1, 'legend':'Z#rightarrow#tau#tau (left-handed)'}
histPref['ZTT_right*'] = {'style':sHTT_ZL, 'layer':0, 'legend':'Z#rightarrow#tau#tau (right-handed)'}
